...
#End Region
    Public Sub New()
        ...
        InitializeComponent()
        Try
            Dim TmUseTiket As String = filePath & Interaction.GetSetting("AntPrinter", "Printer", "UseTiket")
            If TmUseTiket <> "" Then
...
#Region "For Panel Print Testing"
    ...
    Public Sub WriteTiket(ByVal Nomor As Integer, ByVal Layanan As Integer, ByVal Pelayanan As String, ByVal SisaNomor As Integer)
        Try
