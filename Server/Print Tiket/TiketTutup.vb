...
#End Region
    Public Sub New()
        ...
        InitializeComponent()
        Try
            UseTikets = "Tikets\OpenClose.xml"
...
#Region "For Panel Print Testing"
    ...
    Public Shared Notes As String = "TERIMA KASIH"
    Public Shared TimesLayanan As String = "00:00"
    Public Shared PrintCopy As New Short
    Public Shared PrintName As String = ""
    Public Shared UseTikets As String = "Tikets\OpenClose.xml"
    ...
    Public Sub WriteTiket(ByVal Nomor As Integer, ByVal Layanan As Integer, ByVal Pelayanan As String, ByVal SisaNomor As Integer, ByVal tmpBarcode As String)
        Dim NotesTiket As String
        Dim TimesLayananTiket As String
        NotesTiket = Notes
        TimesLayananTiket = TimesLayanan
        Try
                        ...
                        For count = 0 To strArr.Length - 1
                            ...
                            Try
                                ...
                                ElseIf strArr(0) = "SisaNomor" Then
                                    ctrl.Text = String.Format("{0:00}", SisaNomor)
                                    ctrl.TextAlign = ContentAlignment.BottomLeft
    ...
    Public Sub Print(ByVal pnl As Panel, ByVal CopyPrint As Short)
        ...
        PrntTiket.PrinterSettings.Copies = 1 ' CopyPrint
    ...
    Public Sub PrintTiket()
        ...
        PrintCopy = 1 'Convert.ToInt16(Interaction.GetSetting("AntServer", "Server", "CopyPrint"))
        If PrintName = "" Then
