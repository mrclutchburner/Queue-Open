                        ...
                        For count = 0 To strArr.Length - 1
                            ...
                            Try
                                ...
                                ElseIf strArr(0) = "TextLeft" Then
                                    ...
                                    ctrl.Text = gParam(5)
                                    ctrl.AutoSize = True
                                ElseIf strArr(0) = "OpenClose" Then
                                    ctrl.TextAlign = ContentAlignment.MiddleCenter
                                    ctrl.Text = gParam(5)
                                    ctrl.AutoSize = True
...
#Region "For Panel Print Testing"
    ...
    Private Sub tsbPrint_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsbPrint.Click
        ...
        Try
            ...
            PrintName = Interaction.GetSetting("AntServer", RegrisName, "Printername")
            PrintCopy = Convert.ToInt16(Interaction.GetSetting("AntServer", RegrisName, "CopyPrint"))
            If PrintName = "" Then
                pd.PrinterSettings = New PrinterSettings()
                If DialogResult.OK = pd.ShowDialog(Me) Then
                    PrintName = pd.PrinterSettings.PrinterName
                    Interaction.SaveSetting("AntServer", RegrisName, "Printername", PrintName)
                End If
            End If
...
#Region "Tool Strip"
    ...
    Private Sub tsbText_Click(ByVal sender As Object, ByVal e As EventArgs) Handles tsbText.Click
        ...
        ctrl.Name = LableName
        ctrl.Font = New Font("Arial Narrow", 8, FontStyle.Regular, GraphicsUnit.Point, (CByte(0)))
        Try
            Dim ShowTextBox As New ShowTextBox()
            If ShowTextBox.ShowDialog() = DialogResult.OK Then
                ctrl.Text = ShowTextBox.YourText.Text
            End If
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        ctrl.Location = New Point(50, 365)
        ctrl.Name = LableName
        ctrl.Font = New Font("Arial Narrow", 12, FontStyle.Regular, GraphicsUnit.Point, (CByte(0)))
        Try
            Dim ShowTextBox As New ShowTextBox()
            If ShowTextBox.ShowDialog() = DialogResult.OK Then
                ctrl.Text = ShowTextBox.YourText.Text
    ...
    Private Sub tsbNomor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNomor.Click
        ...
        ctrl.Name = LableName
        ctrl.AutoSize = True
        ctrl.Font = New Font("Arial Narrow", 50, FontStyle.Bold, GraphicsUnit.Point, (CByte(0)))
        ctrl.TextAlign = ContentAlignment.MiddleCenter
        ctrl.Text = "A 001"
        ctrl.TextAlign = ContentAlignment.MiddleCenter
        AddHandler ctrl.MouseEnter, AddressOf control_MouseEnter
    ...
    Private Sub tsbNomorSisa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNomorSisa.Click
        ...
        ctrl.Name = LableName
        ctrl.AutoSize = True
        ctrl.Font = New Font("Arial Narrow", 9, FontStyle.Bold, GraphicsUnit.Point, (CByte(0)))
        ctrl.TextAlign = ContentAlignment.MiddleLeft
        ctrl.Text = "02"
        AddHandler ctrl.MouseEnter, AddressOf control_MouseEnter
        AddHandler ctrl.MouseLeave, AddressOf control_MouseLeave
    ...
    Private Sub tsbService_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbService.Click
        ...
        ctrl.Name = LableName
        ctrl.AutoSize = True
        ctrl.Font = New Font("Arial Black", 12, FontStyle.Bold, GraphicsUnit.Point, (CByte(0)))
        ctrl.TextAlign = ContentAlignment.MiddleCenter
        ctrl.Text = "NAMA LAYANAN"
    ...
    Private Sub tsbPrinters_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbPrinters.Click
        ...
        GroupBox1.Show()
        Try
            nudPrint.Value = CInt(Int(Interaction.GetSetting("AntServer", RegrisName, "CopyPrint")))
    ...
    Private Sub btnSubmite_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmite.Click
        Interaction.SaveSetting("AntServer", RegrisName, "CopyPrint", nudPrint.Value)
...
#End Region
    ...
    Private Sub tspLayanan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tspLayanan.Click
        Dim rnd As New Random()
        Dim randNumber As Integer = rnd.Next(1, 1000)
        Dim LableName As String = "OpenClose"
        ...
        ctrl.Font = New Font("Arial Black", 12, FontStyle.Bold, GraphicsUnit.Point, (CByte(0)))
        ctrl.TextAlign = ContentAlignment.MiddleCenter
        ctrl.Text = "MAAF WAKTU PELAYANAN " & vbCrLf & "SUDAH TUTUP" & vbCrLf & "SILAHKAN KEMBALI BESOK"
        AddHandler ctrl.MouseEnter, AddressOf control_MouseEnter
        AddHandler ctrl.MouseLeave, AddressOf control_MouseLeave
        AddHandler ctrl.MouseDown, AddressOf control_MouseDown
        AddHandler ctrl.MouseMove, AddressOf control_MouseMove
