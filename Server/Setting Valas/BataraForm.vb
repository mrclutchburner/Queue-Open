...
Public Class BataraForm
    ...
    Public Sub UpdateKursValas()
        ...
        Dim query As String = "SELECT * FROM tbBatara ORDER BY ID"
        Try
            Conn.Open()
    ...
    Private Sub AddBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddBtn.Click
        ...
        If (txtJangka.Text <> "") AndAlso (txtIsi1.Text <> "") Then ' AndAlso (txtIsi2.Text <> "") AndAlso (txtIsi3.Text <> "") Then
            Try
                Data.InsertBatara(txtJangka.Text, txtIsi1.Text) ', txtIsi2.Text, txtIsi3.Text)
                dgvValas.Rows.Clear()
                UpdateKursValas()
    ...
    Private Sub UpdateBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UpdateBtn.Click
        Dim Data As New ValasDataTabel()
        If (txtJangka.Text <> "") AndAlso (txtIsi1.Text <> "") Then ' AndAlso (txtIsi2.Text <> "") AndAlso (txtIsi3.Text <> "") Then
            Data.UpdateBatara(txtJangka.Text.Trim(), txtIsi1.Text.Trim(), Integer.Parse(Ilbl.Text.Trim())) ', txtIsi2.Text.Trim(), txtIsi3.Text.Trim(), Ilbl.Text.Trim())
            dgvValas.Rows.Clear()
            UpdateKursValas()
        Else
    ...
    Private Sub DeleteBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteBtn.Click
        Dim Data As New ValasDataTabel()
        Data.DeleteBatara(Integer.Parse(Ilbl.Text.Trim()))
        dgvValas.Rows.Clear()
        UpdateKursValas()
    End Sub
End Class